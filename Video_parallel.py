...
def process_timestep(ti, folder, nGFS, GridsPerR, rmin, rmax, zmin, zmax, lw):
    ...
    if (len(segs) == 0):
        ...
        R, Z, D2, vel, mom, nz = gettingfield(place, zmin, rmin, zmax, rmax, nr, t)
...
def main():
    ...
    parser.add_argument('--nGFS', type=int, default=10000, help='Number of restart files to process')
